    ...
    <section className={`${styles.flexCenter} ${styles.paddingY} flex-col`}>
      <div className={`${styles.flexCenter} md:flex-row flex-col mb-8 w-full`}>
        <div className='flex-1 flex flex-col justify-start mr-10'>
          ...
          <p className={`${styles.paragraph} mt-4 `}>A New Way to Engage with Creators and Businesses on TikTok.
          </p>
        </div>
      ...
      <div className='w-full flex justify-between items-center md:flex-row flex-col pt-6 border-t-[1px] border-t-[#3f3r45]'>
        <p className='font-poppins font-normal text-center text-[14px] leading-[27px] text-white'>
          2023 { webConfigs.name }. All Rights Reserved | Powered by <a href="#" target="_blank" className={`${styles.link}`} >Tiktok Token</a>
        </p>
