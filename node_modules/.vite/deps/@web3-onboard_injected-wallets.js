import {
  ...
  validate
} from "./chunk-JXHOFJRC.js";
import {
  require_joi_browser_min
} from "./chunk-IACTW2ZV.js";
import {
  __commonJS,
  __toESM
...
var metamask = {
  ...
  getIcon: async () => (await import("./metamask-BGZTXDXX.js")).default,
...
var infinitywallet = {
  ...
  getIcon: async () => (await import("./infinitywallet-VJGHNU53.js")).default,
...
var exodus = {
  ...
  getIcon: async () => (await import("./exodus-OACQLP42.js")).default,
...
var frontier = {
  ...
  getIcon: async () => (await import("./frontier-4JPWJTN2.js")).default,
  getInterface: async () => ({
...
var brave = {
  ...
  getIcon: async () => (await import("./brave-QQCKOHAE.js")).default,
...
var binance = {
  ...
  getIcon: async () => (await import("./binance-UZLBMIKP.js")).default,
  getInterface: async () => {
    let tempBNBProvider = {
      ...window.BinanceChain
    };
...
var coinbase = {
  ...
  getIcon: async () => (await import("./coinbase-GKRIVDQC.js")).default,
  getInterface: async () => {
...
var detected = {
  ...
  getIcon: async () => (await import("./detected-WLCA7FLC.js")).default,
  getInterface: async () => ({
...
var trust = {
  ...
  getIcon: async () => (await import("./trust-INE6DGQB.js")).default,
  getInterface: async () => {
...
var opera = {
  ...
  getIcon: async () => (await import("./opera-DZ6VYQEG.js")).default,
  getInterface: async () => ({
...
var status = {
  ...
  getIcon: async () => (await import("./status-7Y67DYXT.js")).default,
  getInterface: async () => {
...
var alphawallet = {
  ...
  getIcon: async () => (await import("./alphawallet-7Q7GG4ME.js")).default,
  getInterface: async () => ({
    provider: createEIP1193Provider(window.ethereum, {
      wallet_switchEthereumChain: UNSUPPORTED_METHOD,
      eth_selectAccounts: UNSUPPORTED_METHOD
...
var apexwallet = {
  ...
  getIcon: async () => (await import("./apexwallet-J4W2EXFF.js")).default,
  getInterface: async () => ({
    provider: window.ethereum
  }),
...
var atoken = {
  ...
  getIcon: async () => (await import("./atoken-VZHB3TD6.js")).default,
  getInterface: async () => ({
    provider: window.ethereum
  }),
  platforms: ["mobile"]
...
var bifrostwallet = {
  ...
  getIcon: async () => (await import("./bifrostwallet-NONY3LY5.js")).default,
...
var bitpie = {
  ...
  getIcon: async () => (await import("./bitpie-SSUEWP75.js")).default,
  getInterface: async () => ({
    provider: createEIP1193Provider(window.ethereum, {
      wallet_switchEthereumChain: UNSUPPORTED_METHOD,
      eth_selectAccounts: UNSUPPORTED_METHOD
...
var blockwallet = {
  ...
  getIcon: async () => (await import("./blockwallet-HPEPNJIG.js")).default,
...
var frame = {
  ...
  getIcon: async () => (await import("./frame-RJEEBQLV.js")).default,
  getInterface: async () => {
    const provider = window.ethereum;
...
var huobiwallet = {
  ...
  getIcon: async () => (await import("./huobiwallet-7YYQRGCY.js")).default,
  getInterface: async () => ({
    provider: createEIP1193Provider(window.ethereum, {
      wallet_switchEthereumChain: UNSUPPORTED_METHOD,
      eth_selectAccounts: UNSUPPORTED_METHOD
...
var hyperpay = {
  ...
  getIcon: async () => (await import("./hyperpay-UYTPXSJ7.js")).default,
  getInterface: async () => ({
    provider: createEIP1193Provider(window.ethereum, {
      wallet_switchEthereumChain: UNSUPPORTED_METHOD,
      eth_selectAccounts: UNSUPPORTED_METHOD
...
var imtoken = {
  ...
  getIcon: async () => (await import("./imtoken-F6SDUFCK.js")).default,
  getInterface: async () => ({
    provider: createEIP1193Provider(window.ethereum, {
      eth_selectAccounts: UNSUPPORTED_METHOD
    })
...
var liquality = {
  ...
  getIcon: async () => (await import("./liquality-MDDMQ2VQ.js")).default,
  getInterface: async () => {
...
var meetone = {
  ...
  getIcon: async () => (await import("./meetone-II7PBWOF.js")).default,
  getInterface: async () => ({
    provider: window.ethereum
  }),
  platforms: ["mobile"]
...
var mykey = {
  ...
  getIcon: async () => (await import("./mykey-67P35AFB.js")).default,
  getInterface: async () => ({
    provider: window.ethereum
  }),
  platforms: ["mobile"]
...
var ownbit = {
  ...
  getIcon: async () => (await import("./ownbit-YPR5FNX5.js")).default,
  getInterface: async () => {
    const provider = createEIP1193Provider(window.ethereum, {
      eth_chainId: ({ baseRequest }) => baseRequest({ method: "eth_chainId" }).then((id) => `0x${parseInt(id).toString(16)}`),
      wallet_switchEthereumChain: UNSUPPORTED_METHOD,
...
var tokenpocket = {
  ...
  getIcon: async () => (await import("./tokenpocket-GA4TBYLR.js")).default,
...
var tp = {
  ...
  getIcon: async () => (await import("./tp-TXLAH4NP.js")).default,
  getInterface: async () => ({
    provider: createEIP1193Provider(window.ethereum, {
      wallet_switchEthereumChain: UNSUPPORTED_METHOD,
      eth_selectAccounts: UNSUPPORTED_METHOD
...
var xdefi = {
  ...
  getIcon: async () => (await import("./xdefi-HQF4JMBS.js")).default,
  getInterface: async () => ({
...
var oneInch = {
  ...
  getIcon: async () => (await import("./oneInch-4RX4RAOL.js")).default,
  getInterface: async () => ({
    provider: createEIP1193Provider(window.ethereum)
  }),
  platforms: ["mobile"]
...
var tokenary = {
  ...
  getIcon: async () => (await import("./tokenary-Z5VNHWFA.js")).default,
  getInterface: async () => ({
    provider: createEIP1193Provider(window.ethereum)
  }),
  platforms: ["all"]
...
var tally = {
  ...
  getIcon: async () => (await import("./tallywallet-REOFN5BZ.js")).default,
  getInterface: async () => ({
...
var zeal = {
  ...
  getIcon: async () => (await import("./zeal-BZKFUJ4I.js")).default,
  getInterface: async () => ({
...
var rabby = {
  ...
  getIcon: async () => (await import("./rabby-KEIL2MGR.js")).default,
  getInterface: async () => ({
    provider: createEIP1193Provider(window.ethereum)
  }),
...
var mathwallet = {
  ...
  getIcon: async () => (await import("./mathwallet-5CX4GSGE.js")).default,
...
var bitget = {
  ...
  getIcon: async () => (await import("./bitget-NEFULOUS.js")).default,
  getInterface: async () => ({
...
var sequence = {
  ...
  getIcon: async () => (await import("./sequence-LIBDWOP3.js")).default,
  getInterface: async () => ({
    provider: window.ethereum
  }),
  platforms: ["all"]
...
var core = {
  ...
  getIcon: async () => (await import("./core-FIYERZWW.js")).default,
...
var bitski = {
  ...
  getIcon: async () => (await import("./bitski-RIOK2FHP.js")).default,
  getInterface: async () => ({
...
var zerion = {
  ...
  getIcon: async () => (await import("./zerion-NMHS6FUA.js")).default,
  getInterface: async () => ({
    provider: createEIP1193Provider(window.ethereum)
  }),
  platforms: ["all"]
...
var enkrypt = {
  ...
  getIcon: async () => (await import("./enkrypt-V6JA3LA6.js")).default,
  getInterface: async () => {
...
var phantom = {
  ...
  getIcon: async () => (await import("./phantom-PA7UX5HY.js")).default,
  getInterface: async () => ({
...
var safepal = {
  ...
  getIcon: async () => (await import("./safepal-FQRIFI2I.js")).default,
  getInterface: async () => ({
    provider: createEIP1193Provider(window.ethereum)
  }),
  platforms: ["all"]
...
var rainbow = {
  ...
  getIcon: async () => (await import("./rainbow-P23EXPGY.js")).default,
...
var okxwallet = {
  ...
  getIcon: async () => (await import("./okxwallet-RLTM4YO7.js")).default,
  getInterface: async () => ({
...
var defiwallet = {
  ...
  getIcon: async () => (await import("./defiwallet-N74UQGIC.js")).default,
  getInterface: async () => ({
...
var safeheron = {
  ...
  getIcon: async () => (await import("./safeheron-E2DJEBA3.js")).default,
  getInterface: async () => ({
...
var talisman = {
  ...
  getIcon: async () => (await import("./talisman-DVNVN252.js")).default,
  getInterface: async () => ({
...
var ronin = {
  ...
  getIcon: async () => (await import("./roninwallet-N6AWM4W3.js")).default,
  getInterface: async () => ({
...
var onekey = {
  ...
  getIcon: async () => (await import("./onekey-NYYSRNBR.js")).default,
  getInterface: async () => ({
...
var fordefi = {
  ...
  getIcon: async () => (await import("./fordefi-SZFRE2KO.js")).default,
...
var coin98wallet = {
  ...
  getIcon: async () => (await import("./coin98wallet-SBB25BN5.js")).default,
  getInterface: async () => {
    const ethereumInjectionExists = window.hasOwnProperty(InjectedNameSpace.Ethereum);
    let provider;
...
var subwallet = {
  ...
  getIcon: async () => (await import("./subwallet-YX3KBMA7.js")).default,
  getInterface: async () => ({
...
var kayros = {
  ...
  getIcon: async () => (await import("./kayros-CQTIUYUL.js")).default,
  getInterface: async () => ({
...
var foxwallet = {
  ...
  getIcon: async () => (await import("./foxwallet-G5Y5DZ45.js")).default,
  getInterface: async () => ({
...
var Lif3Wallet = {
  ...
  getIcon: async () => (await import("./lif3wallet-PPIMIS3V.js")).default,
  getInterface: async () => ({
    provider: createEIP1193Provider(window.ethereum, {
      wallet_switchEthereumChain: UNSUPPORTED_METHOD,
      eth_selectAccounts: UNSUPPORTED_METHOD
...
var zodiacPilot = {
  ...
  getIcon: async () => (await import("./zodiacpilot-ZKQEHGO5.js")).default,
  getInterface: async () => ({
    provider: createEIP1193Provider(window.ethereum)
  }),
  platforms: ["desktop"],
...
var stablewallet = {
  ...
  getIcon: async () => (await import("./stablewallet-C2MVHST6.js")).default,
